...
<button type="button" class="btn btn-warning btn-edit" data-bs-toggle="modal" data-bs-target="#edit_credit{{$credit->id}}">
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-body">
            <form action="{{route("update", $credit->id)}}" method="POST" id="formedit">
                @method('PATCH')
